...
public abstract class Animal {
     ...
     * Ejemplo: 01 - Un guión (-) o una barra (/) para separar el día del mes. - Un número de dos cifras que represente el mes del año, entre 1 y 12. Si el número del mes solo tiene una cifra, deberá ponerse un 0 delante.
